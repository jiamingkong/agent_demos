...
def get_system_info() -> str:
    ...
    try:
        ...
        info.append(f"Current Time: {now.strftime('%H:%M:%S')} {now.astimezone().tzname()}")
...
@mcp.tool()
def ssh_connect(alias: str, host: str, user: str, port: int = 22, key_path: Optional[str] = None) -> str:
    """
