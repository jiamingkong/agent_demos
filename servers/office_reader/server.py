...
SUPPORTED_FORMATS = [
    ".pdf", ".docx", ".pptx", ".xlsx", ".xls", ".jpg", ".jpeg", ".png", ".gif", ".bmp",
    ".tiff", ".html", ".htm", ".csv", ".json", ".xml", ".zip", ".epub", ".txt",
...
def list_supported_formats() -> str:
    ...
    lines.append("Some formats require additional system libraries (e.g., libreoffice for office files).")
    return "\n".join(lines)
